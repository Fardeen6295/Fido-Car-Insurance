# silver_ingestion_transformed

This folder defines all source code for the 'silver_ingestion_transformed' pipeline:
...
* Take a look at the sample under "sample_users_silver_ingestion_transformed.py" to get familiar with the syntax.
